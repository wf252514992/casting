...
//                    Logger.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private TextView createView(String item) {
        ...
        int padding = Util.dip2px(15, context);
        tv.setPadding(padding, padding, padding, padding);
        if (0 == itemHeight) {
            itemHeight = Util.getViewMeasuredHeight(tv);
...
//            Logger.d(TAG, "向上滚动");
    ...
    private void refreshItemView(int y) {
        ...
        TextView itemView = (TextView) views.getChildAt(position);
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            ...
            paint.setStrokeWidth(Util.dip2px(1f, context));
        }
    ...
    private void onSeletedCallBack() {
        if (null != onWheelViewListener) {
            onWheelViewListener.onSelected(getId(),selectedIndex, items.get(selectedIndex));
        }
