...
import com.example.casting.util.view.refresh.ILoadingLayout.State;
...
public class PullToRefreshGridView extends PullToRefreshBase<GridView> implements OnScrollListener {
    ...
    protected GridView createRefreshableView(Context context, AttributeSet attrs) {
        ...
        String numClolumns =a.getString(R.styleable.GridView_numColumns);
        String verticalSpacing = a.getString(R.styleable.GridView_verticalSpacing);
        String horizontalSpacing = a.getString(R.styleable.GridView_horizontalSpacing);
		gridView.setNumColumns(Integer.parseInt(numClolumns));
		gridView.setVerticalSpacing(Integer.parseInt(verticalSpacing));
		gridView.setHorizontalSpacing(Integer.parseInt(horizontalSpacing));
        mGridView = gridView;
